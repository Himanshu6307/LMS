      ...
      {!loading ?
        <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
          ...
          <div className='absolute lg:top-[30%] top-[75%] md:top-[80%] w-[100%] flex items-center justify-center gap-3 flex-wrap'>
            <button className='px-[20px] py-[10px] border-2 lg:border-white border-black lg:text-white text-black font-light text-[18px] flex gap-2 cursor-pointer'>View All Courses <FaGooglePlay className='w-[30px] h-[30px] fill-black lg:fill-white '  />
            </button>
