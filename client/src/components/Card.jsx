...
function Card({ title, thumbnail, price, category,id }) {
    ...
    return (
        <div onClick={()=>navigate(`/coursepage/${id}`)} className='max-w-[350px] w-full bg-white rounded-[9px] overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-300' >
