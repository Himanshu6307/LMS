...
function Card({ title, thumbnail, price, category,id }) {
    ...
    return (
        <div onClick={()=>navigate(`/coursepage/${id}`)} className='max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-300' >
